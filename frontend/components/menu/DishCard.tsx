      ...
      <div className="px-4 py-3 mt-auto border-t border-gray-100 flex items-center justify-between bg-gray-50/60">
        ...
        {qty === 0 ? (
          <button
            ...
            className="flex items-center gap-1.5 bg-brand-500 hover:bg-brand-600 text-white px-4 py-2 rounded-xl text-sm font-semibold transition-all hover:shadow-lg hover:shadow-brand-500/25 active:scale-95">
